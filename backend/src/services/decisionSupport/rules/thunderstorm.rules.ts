...
export class ThunderstormRules {
...
static airportMessage(
    ...
    static hasMicroburst(
        wx: CanonicalWeatherObservation
    ): boolean {

        if (
            wx.lowLevelWindShear &&
            wx.windGust != null &&
            wx.windSpeed > 0
        ) {

            return (
                (wx.windGust - wx.windSpeed) >= 20
            );
    ...
    /**
     * ============================================================
     * Convective Weather Assessment
     * ============================================================
     */

    static hasConvectiveWeather(
        wx: CanonicalWeatherObservation
    ): boolean {
    ...
    static groundOperationsAllowed(
        wx: CanonicalWeatherObservation
    ): boolean {

        return !(

            this.hasLightning(wx) ||
